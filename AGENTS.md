...
This project is indexed by GitNexus as **vital-guard-ai** (545 symbols, 1010 relationships, 15 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
